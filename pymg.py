...
class Pymg:
    ...
    def __init__(self, display, display_info):
...
class Lable(Widget):
    ...
    def __init__(self, parant, widget_info, scrollSpeed=1, insert=None, loc="Top", brackGround=-1):
...
class Animation(Widget):
    ...
    def gui_update(self):
        ...
        if now_time - self._last_time > self._duration:
            self.buffer.fill(0)
...
class RotaryViewPager(ViewPager):
    ...
    def __init__(self, parant, window_info, scrollSpeed=0.1, back=2, back_count=100, insert=None, loc="Top",
                 brackGround=-1):
        super().__init__(parant, window_info, scrollSpeed, back, back_count, insert, loc, brackGround)
